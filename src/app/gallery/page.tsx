    ...
    <>
      ...
      {selectedImage !== null && (
        ...
        >
          ...
          {/* Previous Button */}
          <button
            className="absolute left-4 text-white text-6xl hover:text-gray-300 hidden md:block z-10"
            onClick={(e) => {
              e.stopPropagation();
              setSelectedImage(
                selectedImage > 0
          ...
          {/* Next Button */}
          <button
            className="absolute right-4 text-white text-6xl hover:text-gray-300 hidden md:block z-10 mr-8"
            onClick={(e) => {
              e.stopPropagation();
              setSelectedImage(
